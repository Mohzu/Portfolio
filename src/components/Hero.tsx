...
const Hero = () => {
  ...
  const availableText = siteContent
    ? lang === 'en' ? siteContent.hero_available_en : siteContent.hero_available_id
    : t.hero.available;
  const greetingText = siteContent
    ? lang === 'en' ? siteContent.hero_greeting_en : siteContent.hero_greeting_id
    : t.hero.greeting;
  const roleText = siteContent
    ? lang === 'en' ? siteContent.hero_role_en : siteContent.hero_role_id
    : t.hero.role;
  const descriptionText = siteContent
    ? lang === 'en' ? siteContent.hero_description_en : siteContent.hero_description_id
    : t.hero.description;
  ...
  return (
    <section
      ...
      style={{
        background: '#F7F4EF',
        /* min-h-dvh: correct for mobile browsers with collapsible toolbar */
        minHeight: '100dvh',
        display: 'flex',
      ...
      <div className="section-container">
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            <span className="section-vol">Vol. 2025</span>
            <span style={{ color: '#C9C5BC' }}>·</span>
            <span className="section-vol">Bandung, Jawa Barat</span>
          </div>
        ...
        {/* Main grid — CSS class handles responsive collapse */}
        <div className="hero-grid">
          ...
          <div>
            ...
            <div className="hero-anim" style={{ transitionDelay: '0.44s' }}>
              <p className="ed-byline">
                ...
                <span style={{ margin: '0 0.75rem', opacity: 0.35 }}>·</span>
                <a
                  href="https://linkedin.com/in/moch-zuhdi-maulana-nabilah-b3219229b"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: 'inherit', textDecoration: 'none' }}
                >
          ...
          {/* RIGHT: ProfileCard — hero-card-col class makes it go to top on mobile */}
          <div
            className="hero-anim hero-card-col"
            style={{
